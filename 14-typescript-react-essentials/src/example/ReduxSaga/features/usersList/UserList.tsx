...
import { deleteUser, fetchUsersRequest } from "./userListSlice";
...
function UserList() {
  ...
  return (
    <div className="user-list">
      ...
      {/* Кнопка загрузки */}
      <button className="load-btn" onClick={(e: React.MouseEvent<HTMLButtonElement>) => dispatch(fetchUsersRequest())}>
        Load Users
      </button>
