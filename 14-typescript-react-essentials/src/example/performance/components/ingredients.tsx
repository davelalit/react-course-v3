...
const Ingredients = (props: { initialIngredients?: any[] }) => {
  console.log("Ingredient rendered");
  
  const [ingredients, setIngredients] = useState<any>(props.initialIngredients || initialIngredients);
// const Ingredients = ({ingredientInfoHelper}) => {
//   console.log("Ingredient rendered");
//   const [ingredients, setIngredients] = useState<any>(initialIngredients);
  ...
  const deleteIngredient = useCallback((id: any) => {
    setIngredients((ingredients: any[]) => ingredients.filter((ing) => ing.id !== id));
  }, []);
