...
const IngredientsList = (props: { ingredients: any[]; deleteIngredient: (id: any) => void }) => {
      ...
      <StyledList>
        {ingredients.map((ingredient) => (
          <StyledListItem key={ingredient.id}>
            ...
            <StyledButton onClick={(e: React.MouseEvent<HTMLButtonElement>) => deleteIngredient(ingredient.id)}>
              X
            </StyledButton>
          </StyledListItem>
        ))}
